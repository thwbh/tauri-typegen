...
fn test_analyzer_extracts_command_details() {
    ...
    let calculate_sum = commands.iter()
...
fn test_analyzer_handles_no_parameters() {
    ...
    let get_server_info = commands.iter()
...
fn test_type_mappings() {
    ...
    // Test Option types
    assert_eq!(analyzer.map_rust_type_to_typescript("Option<String>"), "string | null");
    assert_eq!(analyzer.map_rust_type_to_typescript("Option<i32>"), "number | null");
    
    // Test Vec types
    assert_eq!(analyzer.map_rust_type_to_typescript("Vec<String>"), "string[]");
    assert_eq!(analyzer.map_rust_type_to_typescript("Vec<User>"), "User[]");
    
    // Test Result types
    assert_eq!(analyzer.map_rust_type_to_typescript("Result<User, String>"), "User");
    assert_eq!(analyzer.map_rust_type_to_typescript("Result<Vec<User>, String>"), "User[]");
    ...
    // Test custom types
    assert_eq!(analyzer.map_rust_type_to_typescript("CustomType"), "CustomType");
}
